...
const AccountStatus = Object.freeze({
  statusCodes: {
    PENDING:
      "The account is pending verification. Please complete the process to activate your account.",
    VERIFIED: "The account is verified and online.",
    SUSPENDED:
      "The account has been suspended due to a policy violation. Please contact support.",
